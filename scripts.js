...
// concatenateStrings("Araceli", "Valles");


// for the first function expression, let's write code that returns one result if the number entered by the user is less than 100 ("number is less than 100"), and another message if the number is greater than or equal to 100 ("that is 100 or greater")
